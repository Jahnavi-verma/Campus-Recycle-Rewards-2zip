...
function MiniLeaderRow({ user, rank, isCurrentUser }: { user: User; rank: number; isCurrentUser: boolean }) {
  ...
  return (
    <View style={[styles.miniRow, isCurrentUser && { backgroundColor: colors.secondary, borderRadius: 12 }]}>
      ...
      <Text
        style={[styles.miniName, { color: colors.foreground }, isCurrentUser && { fontFamily: "Outfit_700Bold" }]}
        numberOfLines={1}
      >
...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 28, fontFamily: "Outfit_700Bold", color: "#FFFFFF", lineHeight: 34 },
  greetingSub: { fontSize: 13, fontFamily: "Outfit_400Regular", color: "rgba(255,255,255,0.7)", marginTop: 2 },
  levelChip: { borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6 },
  levelChipText: { color: "#FFFFFF", fontSize: 12, fontFamily: "Outfit_600SemiBold" },
  rankChip: {
    flexDirection: "row", alignItems: "center", gap: 4,
    borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4,
  },
  rankChipText: { color: "#FFD700", fontSize: 12, fontFamily: "Outfit_700Bold" },
  pointsCard: {
    backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 22, padding: 20,
  },
  pointsLabel: { fontSize: 13, fontFamily: "Outfit_500Medium", color: "rgba(255,255,255,0.8)", marginBottom: 2 },
  pointsVal: { fontSize: 52, fontFamily: "Outfit_700Bold", color: "#FFFFFF", letterSpacing: -1, marginBottom: 14 },
  ...
  progressText: { fontSize: 12, fontFamily: "Outfit_400Regular", color: "rgba(255,255,255,0.65)" },
  streakPill: {
    flexDirection: "row", alignItems: "center", gap: 3,
    backgroundColor: "rgba(255,179,0,0.2)", borderRadius: 12,
    paddingHorizontal: 8, paddingVertical: 3,
  },
  streakPillText: { color: "#FFB300", fontSize: 11, fontFamily: "Outfit_700Bold" },
  bonusBanner: {
    flexDirection: "row", alignItems: "center", gap: 8,
    marginHorizontal: 16, marginTop: 14,
    borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12,
  },
  bonusBannerText: { flex: 1, color: "#FFFFFF", fontSize: 13, fontFamily: "Outfit_600SemiBold" },
  bonusBannerMult: { color: "#FFFFFF", fontSize: 18, fontFamily: "Outfit_700Bold" },
  ...
  metricVal: { fontSize: 18, fontFamily: "Outfit_700Bold", marginTop: 4, textAlign: "center" },
  metricLabel: { fontSize: 10, fontFamily: "Outfit_400Regular", textAlign: "center", lineHeight: 14 },
  ...
  scanCtaTitle: { color: "#FFFFFF", fontSize: 16, fontFamily: "Outfit_700Bold" },
  scanCtaSub: { color: "rgba(255,255,255,0.75)", fontSize: 12, fontFamily: "Outfit_400Regular", marginTop: 1 },
  factCard: {
  ...
  campusTitle: { color: "rgba(255,255,255,0.9)", fontSize: 14, fontFamily: "Outfit_700Bold" },
  campusStats: { flexDirection: "row", alignItems: "center" },
  campusStat: { flex: 1, alignItems: "center" },
  campusStatVal: { color: "#FFFFFF", fontSize: 20, fontFamily: "Outfit_700Bold" },
  campusStatLabel: { color: "rgba(255,255,255,0.65)", fontSize: 11, fontFamily: "Outfit_400Regular", marginTop: 2 },
