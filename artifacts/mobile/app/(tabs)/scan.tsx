...
const styles = StyleSheet.create({
  ...
  scanTitle: {
    fontSize: 22, fontFamily: "Inter_700Bold", color: "#FFFFFF", marginBottom: 8,
  },
  scanSub: {
  ...
  manualBtnText: { color: "#FFFFFF", fontSize: 15, fontFamily: "Inter_600SemiBold" },
  webCamPlaceholder: { alignItems: "center", justifyContent: "center", backgroundColor: "#111111", gap: 12 },
  webCamText: { color: "rgba(255,255,255,0.35)", fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  logSub: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 1 },
  sectionLabel: {
  ...
  toggleText: { fontSize: 15, fontFamily: "Inter_700Bold" },
  togglePts: { fontSize: 10, fontFamily: "Inter_400Regular" },
  quantityRow: {
  ...
  qtyVal: { fontSize: 32, fontFamily: "Inter_700Bold", minWidth: 60, textAlign: "center" },
  comboBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 3 },
  comboText: { color: "#FFFFFF", fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 1 },
  multiplierBox: {
  ...
  multiplierTitle: { flex: 1, fontSize: 13, fontFamily: "Inter_700Bold", color: "#FF8F00" },
  multiplierTotal: { fontSize: 18, fontFamily: "Inter_700Bold", color: "#FF6D00" },
  multiplierRow: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 4 },
  multiplierDot: { width: 8, height: 8, borderRadius: 4 },
  multiplierLabel: { flex: 1, fontSize: 12, fontFamily: "Inter_400Regular", color: "#5D4037" },
  multiplierVal: { fontSize: 12, fontFamily: "Inter_700Bold" },
  previewCard: { borderRadius: 16, padding: 20, marginBottom: 20 },
  previewRow: { flexDirection: "row", alignItems: "center" },
  previewItem: { flex: 1, alignItems: "center" },
  previewVal: { fontSize: 28, fontFamily: "Inter_700Bold" },
  previewBase: { fontSize: 11, fontFamily: "Inter_400Regular" },
  previewLabel: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  ...
  successTitle: { fontSize: 28, fontFamily: "Inter_700Bold", marginBottom: 6 },
  successSub: { fontSize: 15, fontFamily: "Inter_400Regular", marginBottom: 32, textAlign: "center" },
  ...
  rewardMult: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  rewardLabel: { fontSize: 12, fontFamily: "Inter_400Regular", textAlign: "center" },
  challengeToast: {
    flexDirection: "row", alignItems: "center", gap: 8,
    borderRadius: 16, paddingHorizontal: 18, paddingVertical: 12,
    marginBottom: 20, width: "100%",
  },
  challengeToastText: { color: "#FFFFFF", fontSize: 13, fontFamily: "Inter_600SemiBold", flex: 1 },
  doneBtn: {
    borderRadius: 16, paddingVertical: 18, paddingHorizontal: 48,
    alignItems: "center", minWidth: 200,
  },
  doneBtnText: { color: "#FFFFFF", fontSize: 16, fontFamily: "Inter_700Bold" },
  ...
  permText: { fontSize: 14, fontFamily: "Inter_400Regular" },
  permBtn: {
    flexDirection: "row", alignItems: "center", gap: 8,
    borderRadius: 14, paddingVertical: 14, paddingHorizontal: 24, marginTop: 4,
  },
  permBtnText: { color: "#FFFFFF", fontSize: 15, fontFamily: "Inter_700Bold" },
});
